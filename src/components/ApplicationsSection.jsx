...
export default function ApplicationsSection() {
  return (
    <section className="relative py-24 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-violet-600/[0.01] to-transparent" />
          ...
          {applications.map((app, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className={`group relative p-6 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/[0.08] hover:border-cyan-500/30 transition-all duration-500 cursor-default overflow-hidden ${
                  isLarge
              ...
              >
                <motion.div
                  className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-cyan-500/[0.08] via-violet-600/[0.04] to-transparent rounded-2xl"
                  initial={{ opacity: 0 }}
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500/[0.1] to-violet-600/[0.1] border border-cyan-500/20 flex items-center justify-center mb-4 group-hover:border-cyan-500/40 transition-colors duration-500">
